...
const PAGES = [
  ...
  {
    path: '/vaccine-plan',
    label: 'แผนวัคซีนตามอายุ',
    strong: ['แผนวัคซีน', 'แผนการฉีด', 'ตารางวัคซีนตามอายุ', 'วัคซีนตามอายุ', 'ตารางฉีดวัคซีน'],
    weak: [],
  },
  {
    // ต้องมาก่อน /vaccine เพราะมีคำว่าวัคซีนเหมือนกัน
    path: '/vaccine-info',
    label: 'ข้อมูลวัคซีน',
    strong: ['ข้อมูลวัคซีน', 'หน้าข้อมูลวัคซีน', 'รายละเอียดวัคซีน', 'วัคซีนปากเท้า', 'วัคซีนปากและเท้า'],
    weak: [],
  },
  {
    // ต้องมาก่อน /vaccine เพราะ "วิธีฉีดวัคซีน" มีคำว่าวัคซีนเหมือนกัน
    path: '/vaccine-guide',
    label: 'วิธีฉีดวัคซีน',
    strong: ['วิธีฉีดวัคซีน', 'วิธีการฉีดวัคซีน', 'วิธีฉีด', 'ตำแหน่งฉีด', 'คู่มือฉีด', 'หน้าคู่มือวัคซีน', 'ฉีดตรงไหน'],
    weak: ['คู่มือ'],
  },
  {
    path: '/vaccine',
  ...
  },
  {
    path: '/tasks',
    label: 'งานวันนี้',
    strong: ['งานวันนี้', 'งานที่ต้องทำ', 'มีงานอะไรบ้าง', 'รายการงาน', 'งานค้าง'],
    weak: [],
  },
  {
    path: '/disease-fmd',
    label: 'อาการโรคปากและเท้าเปื่อย',
    strong: ['อาการปากเท้าเปื่อย', 'อาการโรคปากและเท้าเปื่อย', 'ลักษณะโรคปากเท้าเปื่อย', 'หมูเป็นปากเท้าเปื่อย'],
    weak: [],
  },
  {
    path: '/vet',
    label: 'ปรึกษาสัตวแพทย์',
    strong: ['ปรึกษาสัตวแพทย์', 'ปรึกษาหมอ', 'ถามหมอ', 'โพสต์ปรึกษา', 'ชุมชนสัตวแพทย์'],
    weak: ['สัตวแพทย์'],
  },
  {
    path: '/settings',
